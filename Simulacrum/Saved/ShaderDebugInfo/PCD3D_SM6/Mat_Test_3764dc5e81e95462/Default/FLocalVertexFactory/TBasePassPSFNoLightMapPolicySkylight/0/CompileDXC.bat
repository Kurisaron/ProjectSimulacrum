@ECHO OFF
SET DXC="D:\EpicLibrary\UE_5.6\Engine\Binaries\ThirdParty\ShaderConductor\Win64\dxc.exe"
IF NOT EXIST %DXC% (
	ECHO Couldn't find dxc.exe under "D:\EpicLibrary\UE_5.6\Engine\Binaries\ThirdParty\ShaderConductor\Win64"
	GOTO :END
)
